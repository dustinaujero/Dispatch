...
ActiveRecord::Schema.define(version: 2019_04_24_002331) do
  ...
  create_table "directs", force: :cascade do |t|
    ...
    t.index ["userA", "userB"], name: "index_directs_on_userA_and_userB", unique: true
  end
